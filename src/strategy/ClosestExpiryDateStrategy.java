...
public class ClosestExpiryDateStrategy implements BatchSelectionStrategy {
    @Override
    public List<BatchSelection> selectBatches(List<MainStock> mainStocks, int requiredQuantity) {
        ...
        // Sort mainStocks by expiry date (closest first)
        mainStocks.sort((s1, s2) -> s1.getExpiryDate().compareTo(s2.getExpiryDate()));
