...
<head>
    <meta charset="UTF-8">
    <title>Reshelf Web Stock</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-4">
        <h2>Reshelf Web Stock</h2>
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <p class="card-text">This operation will automatically reshelf items from main stock to web stock based on available quantities and expiry dates.</p>
                
                <form action="${pageContext.request.contextPath}/webstock/reshelf" method="post">
                    <div class="mb-3">
