...
<html>
<head>
    <title>SYOS ERP - Add Reorder Level</title>
        ...
        <header class="bg-indigo-600 text-white shadow-md">
            <div class="container mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold">SYOS ERP - Add Reorder Level</h1>
        ...
        <main class="flex-grow container mx-auto px-6 py-8">
            <div class="max-w-3xl mx-auto">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6">
                        <h2 class="text-xl font-semibold text-gray-800 mb-6 border-b pb-2">Add New Reorder Level</h2>
                        ...
                        <form action="${pageContext.request.contextPath}/reorderlevel" method="post">
                            ...
                            <!-- Item Selection -->
                            <div class="mb-4">
                                <label for="itemId" class="block text-gray-700 text-sm font-bold mb-2">Select Item:</label>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="number" id="thresholdQuantity" name="thresholdQuantity" required min="0"
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
