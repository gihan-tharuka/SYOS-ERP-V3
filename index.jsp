...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex flex-col items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <div class="space-y-4">
            ...
            <a href="jsp/customer/register.jsp" class="block w-full bg-white border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 font-medium py-3 px-4 rounded-lg transition duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">
                Register as Customer
            </a>
        </div>

        <div class="mt-6 text-sm text-gray-500">
            Need admin access? <a href="#" class="text-indigo-600 hover:text-indigo-800">Contact admin</a> for access.
        </div>
    </div>
</body>
</html>